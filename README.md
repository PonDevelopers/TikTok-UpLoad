...
**cURL:**
```bash
curl -X POST https://lechaukhaapi.eu.org/monetization \
  -H "X-API-Key: your_key_here" \
  -H "Content-Type: application/json" \
  -d '{"cookies": "sessionid=abc;msToken=xyz"}'
```
...
r = requests.post(
    "https://lechaukhaapi.eu.org/monetization",
    headers={"X-API-Key": "your_key_here"},
    json={"cookies": "sessionid=abc;msToken=xyz;..."},
)
print(r.json())
...
**cURL:**
```bash
curl -X POST https://lechaukhaapi.eu.org/add_product \
  -H "X-API-Key: your_key_here" \
  -H "Content-Type: application/json" \
  -d '{"cookies": "sessionid=abc;...", "product_id": "1730987654321"}'
```
...
r = requests.post(
    "https://lechaukhaapi.eu.org/add_product",
    headers={"X-API-Key": "your_key_here"},
    json={"cookies": "sessionid=abc;...", "product_id": "1730987654321"},
)
print(r.json())
